...
const images = () => {
  return gulp
    .src(dir.src + "assets/img/**/*.{png,jpg,svg}")
    .pipe(
      imagemin([
...
const toWebp = () => {
  return gulp
    .src(dir.src + "assets/img/**/*.{png,jpg}")
...
const svgSprite = () => {
  return gulp
    .src(dir.src + "assets/img/sprite/*.svg")
    .pipe(
      svgstore({
        inlineSvg: true,
      })
    ...
    .pipe(gulp.dest(dir.src + "assets/img"));
};
...
const copy = () => {
  return gulp
    .src(
      [dir.src + "js/**/*", dir.src + "assets/img/**/*", dir.src + "*.ico"],
      {
        base: dir.src,
      }
    )
...
const watch = () => {
  ...
  gulp.watch([dir.src + "assets/img/**/*"], gulp.series(copy));
};
